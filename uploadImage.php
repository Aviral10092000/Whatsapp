...
<body id='content_area'>
  ...
  <input type="text" class="form-control" aria-label="Default" name="description" aria-describedby="inputGroup-sizing-default" value="">
</div>

<button class="btn btn-outline-secondary" type="submit" name="submit" value="UPLOAD">Button</button>
